      ...
      <nav className="binance-navbar">
        <div className="nav-left">
          ...
          <ul className="nav-menu">
            <li>
              <span className="nav-link-item">Buy Crypto</span>
            </li>
            <li>
              <span className="nav-link-item">Markets</span>
            </li>
            <li>
            ...
            <li>
              <span className="nav-link-item">Earn</span>
            </li>
            <li>
              <span className="nav-link-item">
                Square{" "}
        ...
        <div className="nav-right">
          ...
          <button className="nav-icon-btn" style={{ position: "relative" }}>
            ...
            {isSocketConnected && (
              <span
                className="socket-connected-badge"
                title="Live WebSocket Active"
              ></span>
            )}
          </button>
          <button className="nav-icon-btn">
