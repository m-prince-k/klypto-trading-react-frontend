    ...
    <div className="binance-card mb-3">
        ...
        <div className="card-body py-3">
            <div className="row g-3 row-cols-1 row-cols-md-3 row-cols-xl-5">
                ...
                {/* Bitcoin Dominance */}
                <div className="col">
                    <div className="indicator-box d-flex align-items-center px-3 py-2 rounded">
                        ...
                        <div className="flex-grow-1">
                            <div className="text-muted extremely-small mb-1">Bitcoin Dominance</div>
                ...
                <div className="col">
                    <div className="indicator-box d-flex align-items-center px-3 py-2 rounded">
                        ...
                        <div className="flex-grow-1">
                            <div className="text-muted extremely-small mb-1">Funding Rate (Avg.)</div>
                            <div className="d-flex justify-content-between align-items-baseline">
                ...
                <div className="col">
                    <div className="indicator-box d-flex align-items-center px-3 py-2 rounded">
                        ...
                        <div className="flex-grow-1">
                            <div className="text-muted extremely-small mb-1">Trading Volume (24h)</div>
                            <div className="d-flex justify-content-between align-items-baseline">
                ...
                <div className="col">
                    <div className="indicator-box d-flex align-items-center px-3 py-2 rounded">
                        ...
                        <div className="flex-grow-1">
                            <div className="text-muted extremely-small mb-1">Volatility (24h)</div>
                            <div className="d-flex justify-content-between align-items-baseline">
                ...
                {/* Derivatives Volume */}
                <div className="col">
                    <div className="indicator-box d-flex align-items-center px-3 py-2 rounded border-0">
                        <div className="indicator-icon me-3">
                            <div className="icon-circle bg-success-dim text-success d-flex align-items-center justify-content-center rounded-circle" style={{ width: '36px', height: '36px' }}>
                        ...
                        <div className="flex-grow-1">
                            <div className="text-muted extremely-small mb-1">Derivatives Volume (24h)</div>
                            <div className="d-flex justify-content-between align-items-baseline">
