    ...
    <div className="fin-footer">
      ...
      <div className="fin-footer-grid">
        ...
        <div className="fin-footer-col" style={{flex: 1.2}}>
          <h4 style={{color: '#fff', textAlign: 'center'}}>FINAL JUDGEMENT FACTORS</h4>
          <div className="fin-footer-list" style={{gap: '8px', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', marginTop: '10px'}}>
            <div className="fin-footer-item"><div style={{width:'14px', height:'14px', borderRadius:'50%', background:'#10b981', display:'flex', alignItems:'center', justifyContent:'center', color:'#000', fontSize:'8px', fontWeight:'bold'}}>A</div> <span style={{color: '#fff', fontSize: '9px'}}>Adoption Potential</span></div>
            <div className="fin-footer-item"><div style={{width:'14px', height:'14px', borderRadius:'50%', background:'#10b981', display:'flex', alignItems:'center', justifyContent:'center', color:'#000', fontSize:'8px', fontWeight:'bold'}}>U</div> <span style={{color: '#fff', fontSize: '9px'}}>Real Use Case</span></div>
            <div className="fin-footer-item"><div style={{width:'14px', height:'14px', borderRadius:'50%', background:'#ef4444', display:'flex', alignItems:'center', justifyContent:'center', color:'#000', fontSize:'8px', fontWeight:'bold'}}>R</div> <span style={{color: '#fff', fontSize: '9px'}}>Risk vs Reward</span></div>
          </div>
        </div>
      </div>
    </div>
