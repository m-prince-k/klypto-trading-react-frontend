...
//   { symbol: "BTCUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "ETHUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "SOLUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "ADAUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "XRPUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "DOGEUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "DOTUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "LTCUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "LINKUSDT", lastPrice: 0, change: 0, changePercent: 0 },
//   { symbol: "AVAXUSDT", lastPrice: 0, change: 0, changePercent: 0 },
// ];
  ...
  useEffect(() => {
    ...
    const handleWatchlistUpdate = (tick) => {
      ...
      const normalized = {
        ...
        change: tick.change,
        changePercent: tick.changePct ?? tick.changePercent,
        volume: tick.volume ?? tick.vol,   // ← add this
